...
* Go into that folder.
* Create a file called `words.txt` and add your name to that file.
...
* Run `git clone [the url you copied]`.
  * <details>
    ...
    This takes what's on GitHub and essentially downloads it so you can now make changes to it on your local computer without disrupting the files on GitHub.
